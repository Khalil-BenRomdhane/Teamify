...
<div className="fw-bold">Hour : {props.hour}</div><div className="fw-bold col-4 position-relative " style={{left:'360px',bottom:'55px'}}><BsFillFileEarmarkPdfFill style={{color:'red'}} size={40}/></div>
