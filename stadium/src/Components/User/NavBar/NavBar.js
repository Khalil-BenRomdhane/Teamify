...
function NavBar(props) {
  ...
  return (
    <div className="nav">
      ...
      <input type='text' placeholder='Search'  style={{width:'260px',height:'42px',background:'white'}} 
             className=" rounded-5 border-white h6 ps-3 text-dark " 
          />
          <AiOutlineSearch size={31} style={{right:'45px',top:'7px'}} className='text-dark position-relative'/>
</div>
